...
vec3 TressFX_ComputeDiffuseSpecFactors(vec3 vEyeDir, vec3 vLightDir, vec3 vTangentDir, float coneAngleRadians = 10*AMD_PI/180 ) {
    // From old code.
